...
let myvar1 = "This is the first variable";
console.log(myvar1);

/* 2. Access the 2nd and 6th elements of the string. Print the elements to the console. 
**Make sure you have selected the right index numbers**  */
console.log(myvar1[1], myvar1[5]);
