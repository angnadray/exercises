...
console.log(client); // { userName: 'Lila19', plan: 'Gold', contract: '2 years' }
...
// Lila Moon is a 23 year old Dancer living in Berlin.

/* 3. Write a JavaScript program to delete the "class" property (or last property) from the previous 
object. */
