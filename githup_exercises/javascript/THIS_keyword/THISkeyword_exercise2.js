...
myFather and myMother are created.
...
constructor using this. The cars should have instance "brand","name","year" and "price". 
Also create 3 different objects using the constructor function, initialzing the instances 
whatever you want.
...
let obj = {name: "Sandra"}
Create a greeting function with the parameters a, b -> city, country. Use the this keyword and 
...
Create a function that sets a new age for a property in an object. Create 2 or three new objects 
for different people e.g. Sandra, Karl, Tim. Set the age of each object. Then, change their ages 
with your function! */



/* 8. GoT
Read over the following code. Then try to add Joffrey, Myrcella and Tommen into the House Lannister 
(Choose Cersei as parent).
